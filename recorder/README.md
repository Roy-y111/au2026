...
**[⬇ au2026rec-0.1.3-win64.zip](https://github.com/shuotao/au2026/releases/latest)** — 免安裝，解壓縮後點兩下 `au2026rec.exe`，選 **1** 走引導設定。不需要 Python。
...
* 錄下的檔案**不得**公開散布、上傳分享平台、轉載、翻譯後散布、販售，
  或用於任何商業、教學營利、公開播映用途。
* 用 `srt` 指令產出的逐字稿與中文字幕屬課程內容的衍生物，同樣只供個人學習，
  不得公開散布或上傳。
